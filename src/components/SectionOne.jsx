        ...
        <>
            <div className="flex flex-col md:flex-row mx-auto w-full pt-28 md:pt-20 lg:pt-0 lg:w-[1210px] bg-[rgba(33, 33, 39, 0.7)] lg:h-screen lg:items-center gap-16 lg:gap-0" id="inicio">
                <div className="lg:w-8/12 lg:pr-8 my-auto">
                    ...
                    <p className="mb-4 text-xs lg:text-lg lg:pr-14 parrafo-inicio">Lorem ipsum dolor sit amet consectetur adipisicing elit. Eos aliquam, quo sit temporibus vero libero. Laudantium repudiandae iste quas soluta nostrum odit quo, nam amet molestias suscipit provident ex officiis.</p>
