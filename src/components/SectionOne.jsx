...
export default function SectionOne() {
    ...
    React.useEffect(() => {
      const typed = new Typed(el.current, {
        strings: ['desarrollador', 'programador', 'freelancer' ],
        typeSpeed: 50,
        loop: true,
      });
    ...
    return(
        <>
            <div className="flex flex-col md:flex-row mx-auto w-full pt-20 md:pt-20 lg:pt-28 max-w-[1250px] bg-[rgba(33, 33, 39, 0.7)] lg:h-[98vh] lg:items-center gap-16 lg:gap-0" id="inicio">
                <div className="lg:w-9/12 lg:pr-8 my-auto">
                ...
                <div className="img-container lg:w-3/12 backdrop-blur-sm">
                    <img src={Profile} alt="Foto Perfil" title="Carlos" className="max-w-[300px] object-cover" id="imagen-inicio" />
                </div>
            </div>
        </>
    );
